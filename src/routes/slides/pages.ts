export const pages = [
    ...
    { path: "datatable-component.html", title: "DataTable Component" },
    ...
    { path: "keyframe-studio.html",   title: "Keyframe Studio" },
    { path: "keyframe-reuse.html",    title: "KeyframeStudio Reuse" },
