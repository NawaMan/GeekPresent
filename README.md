...
There's also a **PRINT** entry, in the top-centre tool bar's hamburger (☰) menu — hover the ☰ at the bar's right end and OVERVIEW / CAPTURE / PRINT drop down. It opens a small menu of destinations the browser's own dialog can't ask about:
